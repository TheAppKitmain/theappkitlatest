...
class AdminaboutappController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       return view("admin.super_admin.adminaboutapp",compact('about_app'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($aboutapp)){
            ...
            session()->put('user_id', $aboutapp->id);
            session::flash('statuscode','info');
            return back()->with('status','App is added');
        } 
        else
        {
