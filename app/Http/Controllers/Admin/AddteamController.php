...
class AddteamController extends Controller
{
    ...
    public function index(){
        return view('admin.super_admin.addteam');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['member_designation'] = $request->member_designation;
        ...
        $myteam = Myteam::create($data);
        session::flash('statuscode','info');
        return redirect('admin')->with('status','Data is Added');
    }
