...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = FoodAppUser::where('owner_id', $id)->where('template_id', $template_id)->orderBy('id','desc')->get();
        return view('admin.template.Food_Delivery.food_customers',compact('users'));
