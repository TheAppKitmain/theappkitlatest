...
class MyOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.template.Booking.orders.my_orders', compact('themetemplate','orders','data'));        
        }
        else{
            Auth::logout();
	...
	public function new_orders()
	{
		...
		return view('admin.template.Booking.orders.new_orders',compact('data'));
	}
	...
	public function confirmed_orders()
	{
		...
		return view('admin.template.Booking.orders.confirmed_orders',compact('data'));
	}
	...
	public function shipped_orders()
	{
		...
		return view('admin.template.Booking.orders.shipped_orders',compact('data'));
	}
    ...
    public function show($id)
    {
		...
		$order->order_total = 0;
		return view('admin.template.Booking.orders.order_details',compact('order','address','shipping','created_at'));
    }
