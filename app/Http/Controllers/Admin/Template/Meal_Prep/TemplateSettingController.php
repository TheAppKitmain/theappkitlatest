...
class TemplateSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        if($theme_code == 'ase-eats_PX3IQP'){
            return view('admin.template.Meal_Prep.themes.asa_eats',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting')); 
        }
    ...
    public function show($id)
    {
        ...
        if($themetemplate->theme_code == 'ase-eats_PX3IQP'){
            return view('admin.template.Meal_Prep.themes.asa_eats',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting')); 
        }
