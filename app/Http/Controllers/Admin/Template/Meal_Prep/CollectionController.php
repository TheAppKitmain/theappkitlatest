...
use App\Models\Template\Meal_Prep\MealCollection;
use App\Usertheme;
...
class CollectionController extends Controller
{
    ...
    {
        $check = MealCollection::where('user_id',$request->user_id)
        ...
        $ecommercecollection = MealCollection::create($data);
        session::flash('statuscode','info');
    ...
    public function edit($id)
    {
        ...
        $collection = MealCollection::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $collection_name = MealCollection::find($id);   
        ...
        $collection = MealCollection::where('id',$id)->update($data);
        session::flash('statuscode','info');
