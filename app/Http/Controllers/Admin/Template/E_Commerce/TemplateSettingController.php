...
class TemplateSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        if($theme_code == 'war_678'){
            return view('admin.template.E_Commerce.themes.wardrobe_setting',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }elseif($theme_code == 'red_896'){
            return view('admin.template.E_Commerce.themes.reddress_setting',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }elseif($theme_code == 'fur_369'){
            return view('admin.template.E_Commerce.themes.shop_your_way',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }elseif($theme_code == 'beauty-creams_UYV8KR'){
           
        return view('admin.template.E_Commerce.themes.beauty_creams',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }
    ...
    public function show($id)
    {
        ...
        if($themetemplate->theme_code == 'war_678'){
            return view('admin.template.E_Commerce.themes.wardrobe_setting',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }elseif($themetemplate->theme_code == 'red_896'){
            return view('admin.template.E_Commerce.themes.reddress_setting',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }elseif($themetemplate->theme_code == 'fur_369'){
            return view('admin.template.E_Commerce.themes.shop_your_way',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }elseif($themetemplate->theme_code == 'beauty-creams_UYV8KR'){
            //session()->put('lastname', 'beauty');
            return view('admin.template.E_Commerce.themes.beauty_creams',compact('splashscreen','themetemplate','collections','temploginsetting','products','tempsignupsetting'));
        }
