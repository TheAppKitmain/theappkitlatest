                        ...
                        <tr>
                            <td
                                ...
                                <a href="https://theappkit.co.uk/"
                                    ...
                                    target="_blank">
                                    <img src="https://ci5.googleusercontent.com/proxy/uoZGk2TqNSQ-sBfLaSKosZtDglcEp-FQGAGYjEVV5R_erC2Js1I6-6q2TkiZlDm09jHoGskwqoXMo3k8aeTtpJOVMv1SfKdaraB1bkXuJJBI=s0-d-e1-ft#https://dev.theappkit.co.uk/gradeA_Transportation/public/images/logo.jpeg"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                ...
                                                <?php $bugs = App\Bug::whereIn('id', $dataList['bug_id'])->get(); ?>
    ...
    background: linear-gradient(to right, #611fd6 0%, #48cfe3 100%);">
                                                        <tbody
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';color:#fff;font-size:15px;line-height:18px;margin:0;padding:5px 0 10px;width:100%">
                                                                    {{ $data->bug_description }}</td>
                                                            </tr>
                                                            @if ($data->bug_screenshot !== null)
                                                                <tr>
                                                                    <td
                                                                        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';color:#fff;font-size:15px;line-height:18px;margin:0;padding:10px 0 0px;width:100%;font-weight:bold;">
                                                                        Bug Screenshot</td>
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';color:#fff;font-size:15px;line-height:18px;margin:0;padding:5px 0 10px;width:100%">
                                                                        <a href="#"><img
                                                                                src="{{ asset($data->bug_screenshot) }}"
                                                                                alt="unnamed" border="0"></a></td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
                                                    </table>
