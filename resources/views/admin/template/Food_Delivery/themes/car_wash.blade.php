                                                   ...
                                                   <div class="col-lg-12">
                                                      ...
                                                      <div class="tab-content tab-right-pr food1tbpro">
                                                         <div class="tab-pane fade show active" id="product_home" role="tabpanel" aria-labelledby="home-tab">
                                                            <form role="form" data-toggle="validator" action="{{url('theme/theme_add_product/'.request()->route('id'))}}" method="post" enctype="multipart/form-data" id="saveProduct">
                                                               @csrf
                                                               <div class="row">
                                 ...
                                 <div class="col-md-3 own-4-col own-4-col-food-del-1">
                                    ...
                                    <div class="preview-box">
                                          ...
                                          <div class="tutorial-video-box">
                                             <div class="tutorial-video-box-inner foodmaintutorial-video-box-inner">
                                                <div class="app-preview cor-1-app-preview">
                                                  <div class="carwash-1ogoimg">
                                                  <img class="fdlimgtop" src="{{asset('template/images/wego/snngleitmdtlfd.png')}}">
                                                 </div>
                                                <div class="hidescroll scrolheightsiinglpg">
                                                <div class="row mrgnfdrow mrgnfdrowsngledtl">
                                                <div class="col-md-6 pd-5">
                                                   <div class="fditm-fd">
                                                      <div class="fditm-fd-img">
                                                         <img class="fditm-fd-1 product_image_screen" src="{{asset('template/images/wego/itm-fd-2.png')}}">
                                                      </div>
                                                   </div>
                                                </div>
														 <div class="col-md-6 pd-5">
														 <div class="cerfditm-des">
														 <h6 id="pro_name">Strawberries</h6>
														 <p>£<span id="pro_price">20.00 </span></p>
														 <h5 class="text-right"><img class="countfdimg" src="{{asset('template/images/wego/countfd.png')}}"></h5>
														 </div>
														 </div>
														 <div class="col-md-12 pd-5">
														 <div class="cerfditm-des-text">
														 <h6>Description</h6>
														 <p class="pro_short_desc" >Lorem Ipsum is simply dummy text of the printing and 
                                          ...
                                          <div class="toptextcarwash1homeinner">
                                             <div class="slidershop-main">
                                             <h3 class="shopbycatgory">Related Products</h3>
                                             <div class="row mrgnfdrow">
                                                <div class="col-md-6">
                                                   <div class="fditm-fd">
                                                      <div class="fditm-fd-img">
                                                         <img class="fditm-fd-1" src="{{asset('template/images/wego/fdpro1.png')}}">
                                                      </div>
                                                      <h5 class="shopbycatgory">Blueberries</h5>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="fditm-fd">
                                                      <div class="fditm-fd-img">
                                                         <img class="fditm-fd-1" src="{{asset('template/images/wego/fdpro2.png')}}">
                                                      </div>
                                                      <h5 class="shopbycatgory">Gooseberries</h5>
                                                   </div>
                                                </div>
                                                   <div class="col-md-6">
                                                   <div class="fditm-fd">
                                                      <div class="fditm-fd-img">
                                                         <img class="fditm-fd-1" src="{{asset('template/images/wego/fdpro3.png')}}">
                                                      </div>
                                                      <h5 class="shopbycatgory">Apple</h5>
                                                   </div>
                                                </div>
                                                   <div class="col-md-6">
                                                   <div class="fditm-fd">
                                                      <div class="fditm-fd-img">
                                                         <img class="fditm-fd-1" src="{{asset('template/images/wego/fdpro4.png')}}">
                                                      </div>
                                                      <h5 class="shopbycatgory">Apricots</h5>
                                                   </div>
                                                </div>
                                             <div class="col-md-12">
                                                <div class="form-group wego-1-email-group">
                                                      <button class="wego-1-right-button ecom-5-logo-inbtn ecom-mt-20 mrgn0auto" href="#">Add To Cart</button>
                                                   </div>
                                             </div>
                                             </div>
                                          </div>
                                    ...
                                    <div class="tutorial-video-box-inner">
                                       <div class="preview-right-main-wrapper">
                                          ...
                                          <div class="splash-bgimage" id="splash_screen_bg">
                                             <img class="splashbg" src="{{asset('template/images/splashcar1.png')}}" id="splash_bg" alt="eyeimage" >
                                             <img class="applogoimg preview" src="{{asset('template/images/carwash1.png')}}" id="splash_logo" alt="eyeimage">
                                          </div>
                                          @else
                                          ...
                                          <div class="splash-bgimage" id="splash_screen_bg">
                                             <img class="splashbg" src="{{asset('template/images/splashcar1.png')}}" id="splash_bg">
                                             @if($splashscreen->splash_logo == NULL)   
                                             <img class="applogoimg preview" src="{{asset('template/images/carwash1.png')}}" id="splash_logo" alt="eyeimage">
                                             @else 
                                             <img class="applogoimg preview" src="{{asset($splashscreen->splash_logo)}}" id="splash_logo" alt="eyeimage">
                                       ...
                                       <div class="card-body m-t-20">
                                          <form  method ="POST" action="{{route('theme.signupscreen')}}" enctype="multipart/form-data" name="signup_form">
                                             ...
                                             <div class="d-flex form-group">
                                                ...
                                                <input type="color" id="signup_bg_color1" name="signup_btn_color" onchange="signupbtnshow()" value="#2aa8e1">                     
                                             </div>
                                             @else
                                             <div class="d-flex form-group">
                                                <label class="lbh">SignUp Background Color</label>
                                                      ...
                                                      <div class="preview-right-main-wrapper loginsign-ecom">
                                                         <div class="splash-bgimage">
                                                            <div class="ecom-6-beauty-sign">
                                                                  ...
                                                                  <div class="wego-1-form-grp-container wego-1-form-mr">
                                                                  <div class="wego-1-top-image">
                                                                  <img src="{{asset('template/images/carwash1.png')}}">
                                                                  </div>
                                                                  <div class="form-group-scroll-sign hidescroll">
                                                                     <div class="form-group wego-1-email-group">
																	                     <label class="carwash1">Full Name</label>
                                                                        <div class="wego-1-group-icn-inp">
                                                                     ...
                                                                     <div class="form-group wego-1-password-group">
                                                                     ...
                                                                     <div class="form-group wego-1-email-group">
                                                                     <label class="carwash1">Address Line 1</label>
                                                                        <div class="wego-1-group-icn-inp">
                                                                           <input class="form-cantrol" type="text" placeholder="Enter Mobile Number">
                                                                        </div>
                                                                     </div>
                                                                        ...
                                                                        <label class="carwash1">Address Line 1</label>
                                                                        <div class="wego-1-group-icn-inp">
                                                                           <input class="form-cantrol" type="text" placeholder="Waltham Forest, Bridge End">
                                                                        </div>
                                                                     </div>
                                                                           <div class="form-group wego-1-email-group">
                                                                           <label class="carwash1">Address Line 2</label>
                                                                        <div class="wego-1-group-icn-inp">
                                                                           <input class="form-cantrol" type="text" placeholder="Waltham Forest, Bridge End">
                                                                        </div>
                                                                     </div>
                                                                           <div class="form-group wego-1-email-group">
                                                                           <label class="carwash1">Town</label>
                                                                        <div class="wego-1-group-icn-inp">
                                                                           <input class="form-cantrol" type="text" placeholder="London">
                                                                        </div>
                                                                     </div>
                                                                        <div class="form-group wego-1-email-group">
                                                                        <label class="carwash1">Postcode</label>
                                                                        <div class="wego-1-group-icn-inp">
                                                                           <input class="form-cantrol" type="text" placeholder="WC2N 5DU">
                                                                        </div>
                                                                     </div>
																	 
                                                                     <div class="form-group wego-1-email-group">
                                                                     @if(!isset($tempsignupsetting))
                                                                        <button type="button" id="signup_button" class="wego-1-right-button ecom-5-logo-inbtn ecom-mt-20" href="#">Sign Up </button>
                                                                        @else
                                                                        <button type="button" id="signup_button" class="wego-1-right-button ecom-5-logo-inbtn ecom-mt-20" href="#" style="background-color:{{$tempsignupsetting->signup_btn_color}}; font-size:{{$tempsignupsetting->signup_btn_font_size}}px;">Sign Up </button>
                                                                        @endif
                                                                     </div>
																	                  <p class="wego-1-crate-acount-p">Already have a account?<a class="cor-1-crate-acount" href="#"> Log In</a></p>
                                                                  </div>
																               </div>   
                                                            </div>
                                                         </div>
                                       ...
                                       <div class="card-body m-t-20">
                                          <form  method ="POST" action="{{route('theme.loginscreen')}}" enctype="multipart/form-data" name="login_form">
                                             ...
                                             <div class="d-flex form-group">
                                                ...
                                                <input type="color" id="login_bg_color1" name="login_btn_color" onchange="loginbtnshow()" value="#2aa8e1">                     
                                             </div>
                                             @else
                                             <div class="d-flex form-group">
                                                <label class="lbh">Login Background Color</label>
                                       ...
                                       @if(!isset($temploginsetting))
                                          ...
                                          @endif
                                             ...
                                             <div class="form-group-scroll">
                                                ...
                                                <p class="wego-1-crate-forgotpass"><a class="cor-1-crate-acount" href="#">Forgot Password?</a></p>
                                                <div class="form-group wego-1-email-group">
                                                @if(!isset($temploginsetting))
                                                <button type="button" id="login_button" class="wego-1-right-button ecom-5-logo-inbtn ecom-mt-20" href="#">Sign in</button>
                                                @else
                                                <button type="button" id="login_button" class="wego-1-right-button ecom-5-logo-inbtn ecom-mt-20" href="#" style="background-color:{{$temploginsetting->login_btn_color}}; font-size:{{$temploginsetting->login_btn_font_size}}px;">Sign in</button>
                                                @endif
                                                </div>
                                                <p class="wego-1-crate-acount-p">Create a new account? <a class="cor-1-crate-acount" href="#">Sign Up</a></p>
                                             </div>
                                                         </div>
                                                   </div>
                                                </div>
                                 ...
                                 <div class="col-md-4 own-4-col">
                                    ...
                                    <div class="preview-box">
                                       ...
                                       <div class="tutorial-video-box">
                                          <div class="tutorial-video-box-inner foodmaintutorial-video-box-inner">
                                             <div class="carwash-1ogoimg">
                                                <img class="fdlimgtop" src="{{asset('template/images/wego/tiohome.png')}}">
                                             </div>
                                             <div class="carwash-homeinner">
                                                <div class="form-group wego-1-email-group wego-home-gr ">
                                                   <div class="wego-1-group-icn-inp">
                                                      <img class="search_icn" src="{{asset('template/images/wego/ic_search_24px.png')}}">
                                                      <input class="form-cantrol" type="text" placeholder="UK 545 EC1">
                                                   </div>
                                                </div>
                                                <div class="fdcrnerbannerslider-scroll-top hidescroll">
                                                <a href="{{route('theme.banner')}}"><i class="fa fa-plus-circle adfechrplusicon"></i></a>
                                                   <div class="fdcrnerbannerslider">
                                                      <div id="demo" class="carousel slide" data-ride="carousel">
                                                         ...
                                                         @if(count($banner) == 0)
                                                            <div class="carousel-item active">
                                                               <img class="mainsliderfd" src="{{asset('template/images/wego/mainsliderfd.png')}}">
                                                            </div>
                                                         ...
                                                         <div class="carousel-item">
                                                         @endif
                                                            <img class="mainsliderfd" src="{{$data->banner}}">
                                                         </div>
                                                         @endforeach
                                                         @endif
                                                         </div>
                                                   ...
                                                   <div class="slidershop-main">
                                                      <h3 class="shopbycatgory">Shop By Categories</h3>
                                                      <div id="app-showcase" class="app-showcase-main owl-carousel ourworkslider crnrshopourworkslider">
                                                      @if(count($categories) == 0)
                                                         <div class="slide-itm">
                                                            <div class="app-show">
                                                               <div class="">
                                                                  <img class="slhomvm" src="{{asset('template/images/wego/smsliderfd-1.png')}}"alt="">
                                                               </div>
                                                               <h6 class="cthrnfl">Fruits & Veg</h6>
                                                            </div>
                                                         </div>
                                                         <div class="slide-itm">
                                                            <div class="app-show">
                                                               <div class="">
                                                                  <img class="slhomvm" src="{{asset('template/images/wego/smsliderfd-2.png')}}"alt="">
                                                               </div>
                                                               <h6 class="cthrnfl">Food & Drinks</h6>
                                                            </div>
                                                         </div>
                                                         <div class="slide-itm">
                                                            <div class="app-show">
                                                               <div class="">
                                                                  <img class="slhomvm" src="{{asset('template/images/wego/smsliderfd-3.png')}}"alt="">
                                                               </div>
                                                               <h6 class="cthrnfl">Health & Beauty</h6>
                                                            </div>
                                                         </div>
                                                      @else
                                                         @foreach($categories as $category)
                                                            ...
                                                            <div class="app-show">
                                                               <div class="">
                                                                  @if(!isset($category->image))
                                                                     <img class="" src="{{asset('template/images/wego/carwash1.png')}}" alt="">
                                                                  @else
                                                                     <img class="" src="{{$category->image}}" alt="">
                                                                  @endif
                                                               </div>
                                                               <h6 class="cthrnfl">{{$category->name}}</h6>
                                                            </div>
                                                         </div>
                                                         @endforeach
                                                      @endif
                                                   ...
                                                   <div class="slidershop-main">
                                                      <h3 class="shopbycatgory">Featured Products <span class="adfechr"><a href="{{route('theme.food_product_attributes.create')}}"><i class="fa fa-plus-circle"></i></a></span></h3>
                                                      <div class="row mrgnfdrow">
                                                         <div class="col-md-6">
                                                            <div class="fditm-fd">
                                                               <div class="fditm-fd-img">
                                                                  <img class="fditm-fd-1" src="{{asset('template/images/wego/itm-fd-3.png')}}">
                                                               </div>
                                                               <h5 class="shopbycatgory">Strawberries</h5>
                                                               <div class="row no-gutters">
                                                                  <div class="col-md-7">
                                                                     <h6 class="frtname">Fruits & Veg</h6>
                                                                  </div>
                                                                  <div class="col-md-5 text-right">
                                                                     <h6 class="frtname">£20.00</h6>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-6">
                                                            <div class="fditm-fd">
                                                               <div class="fditm-fd-img">
                                                                  <img class="fditm-fd-1" src="{{asset('template/images/wego/itm-fd-1.png')}}">
                                                               </div>
                                                               <h5 class="shopbycatgory">Blueberries</h5>
                                                               <div class="row no-gutters">
                                                                  <div class="col-md-7">
                                                         ...
                                                         <div class="col-md-6">
                                                            <div class="fditm-fd">
                                                               ...
                                                               <h5 class="shopbycatgory">Cheese Burger</h5>
                                                               <div class="row no-gutters">
                                                                  <div class="col-md-7">
                                                                     <h6 class="frtname">Food & Drinks</h6>
                                                                  </div>
                                                                  <div class="col-md-5 text-right">
                                                                     <h6 class="frtname">£40.00</h6>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-6">
                                                            <div class="fditm-fd">
                                                               <div class="fditm-fd-img">
                                                                  <img class="fditm-fd-1" src="{{asset('template/images/wego/itm-fd-2.png')}}">
                                                               </div>
                                                               <h5 class="shopbycatgory">Coca Cola ( Coffee )</h5>
                                                               <div class="row no-gutters">
                                                                  <div class="col-md-7">
                                                                     <h6 class="frtname">Food & Drinks</h6>
                                                                  </div>
                                                                  <div class="col-md-5 text-right">
                                                                     <h6 class="frtname">£30.00</h6>
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         </div>
                                          ...
                                          <div class="app-preview cor-1-app-preview cor-1-group-container">
                                             <div id="theme-showcase-all" class="app-showcase-main owl-carousel">
                                                <div class="theme-slide-itm">
                                                   <img class="appfrm appscreenprewe " src="{{asset('template/images/wego/9.png')}}" alt="">
                                                </div>
                                                <div class="theme-slide-itm">
                                                   <img class="appfrm appscreenprewe " src="{{asset('template/images/wego/14.png')}}" alt="">
                                                </div>
                                                <div class="theme-slide-itm">
                                                   <img class="appfrm appscreenprewe" src="{{asset('template/images/wego/20.png')}}"  alt="">
                                                </div>
                                                <div class="theme-slide-itm">
                                                   <img class="appfrm appscreenprewe"  src="{{asset('template/images/wego/29.png')}}" alt="">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
...
<script>
   ...
   function removelogoimg() {
      document.getElementById("splash_logo").src = "{{asset('template/images/wego/carwash1.png')}}";
   ...
   document.getElementById("splash_bg").src = "{{asset('template/images/wego/splashcar1.png')}}";
