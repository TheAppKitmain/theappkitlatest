...
<div class="main-wrapper ">
    <div class="main-container-inner ">
    	<div class="card-main ">
        	...
        	<div class="">
           		<div class="">
           			<form action="{{route('theme.food_product_attributes.store')}}" method="post" enctype="multipart/form-data">
					   @csrf
		   			...
		   			<div class="row">
						<div class="col-lg-12">
							<div class="form-group f-g-o">
					  			...
					  			<input type="text" class="inputtemp form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Enter Name" name="name" required value="{{ old('name') }}">
					  			@if ($errors->has('name'))
						...
						<div class="col-lg-12">
							<div class="form-group f-g-o">
					  			<label class="labeltemp" for="usr">Select Product</label>
							   	<select name="product_id[]" class="inputtemp form-control select_multiple" id="product_id" value="{{ old('product_id') }}" multiple="multiple" required="">
