         ...
         <div class="row clearfix text-left ">
            <div class="col-md-12">
               <div class="row card owncard">
                  <div class="col-md-12">
                   <h2 class="add_title">Edit Square Credential</h2>

                    <form method ="POST" action="{{route('theme.updatesquare',$square->id)}}" enctype="multipart/form-data" id="stripe_validation">
                     @csrf
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="square_key" class="form-control" value="{{ $square->square_key }}" required>
                     </div>

                     <div class="form-group">
                        <label class="pr-label">Square token</label>
                        <input type="text" name="square_token" class="form-control" value="{{ $square->square_token }}" required>
                     </div>
