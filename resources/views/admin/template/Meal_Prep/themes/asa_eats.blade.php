            ...
            <div class="row">
               <div class="col-md-8 own-8-col">
                  <div class="row card owncard addprdctrow">
                     <div class="col-md-12">
                        <form class="" method="POST" action="{{route('theme.meal_products.store')}}" enctype="multipart/form-data" id="product_validation">
                           @csrf
                           <div class="row">
                                    ...
                                    <div class="carousel-inner">
                                       <div class="carousel-item active">
                                          <div class="product-image-box">
                                             <img class="productimgprv product_image_screen" src="{{asset('asset/images/preview/sad.png')}}" id="product_image_screen" alt="toggle image">
                  ...
                  <div class="tutorial-video-box-inner">
                     <div class="preview-right-main-wrapper">
                        ...
                        <div class="splash-bgimage" id="splash_screen_bg">
                           ...
                           <img class="applogoimg preview" src="{{asset('asset/images/splash/applogo.png')}}" id="splash_logo" alt="eyeimage">
                        </div>
            ...
            <div class="preview-box">
               ...
               <div class="tutorial-video-box text-center">
                  <div class="app-preview cor-1-app-preview cor-1-group-container">
                     <div  class="app-preview-inner e-com-1-app-preview e-com-1-group-container e-com-1-top-heade-nav e-com-1-sign-login">
                        ...
                        <div class="e-com-1-top-header-img">
                           <div class="e-com-1-log-header-img">

                           <!-- @if(!isset($splashscreen))
                              <img class="e-com-1log-img applogoimg preview" id="preview" src="{{asset('images/econ-1-logo.png')}}" alt="">
                           @elseif($splashscreen->splash_logo == NULL)
                              <img class="e-com-1log-img applogoimg preview" id="preview" src="{{asset('images/econ-1-logo.png')}}" alt="">
                           @else
                              <img class="e-com-1log-img applogoimg preview" id="preview" src="{{asset($splashscreen->splash_logo)}}" alt="">
                           @endif -->
                        ...
                        @if(!isset($temploginsetting))
                           ...
                           <img class="login_image" id="login_image" src="{{asset('images/econ-1-top-bg.png')}}" alt="">
                           ...
                           <img class="login_image" id="login_image" src="{{asset($temploginsetting->login_bg_image)}}" alt="">

                        @endif

                        @if(!isset($temploginsetting))

                           <div id="login_image1" class="e-com-1-shap">
                           </div>

                           <div id="login_image2" class="e-com-2-shap">
                           </div>
                        @else
                           <div id="login_image1" class="e-com-1-shap" style="background-color:{{$temploginsetting->login_bg_color}};">
                           </div>
                           <div id="login_image2" class="e-com-2-shap" style="background-color:{{$temploginsetting->login_bg_color}};">
                           </div>
                        @endif

                        </div>
                        <div class="e-com-1-form-grp-container e-com-1-form-mr">
                           <div class="form-group e-com-1-email-group">
                              <label class="e-com-1-gr-label">Email</label>
                              <div class="e-com-1-group-icn-inp">
                                 <i class="fa fa-envelope cor-1-envicon" aria-hidden="true"></i>
                                 <input class="form-cantrol" type="email" placeholder="Enter Your Email">
                              </div>
                           </div>
                           <div class="form-group e-com-1-password-group m-b-5">
                              <label class="e-com-1-gr-label">Password</label>
                              <div class="e-com-1-group-icn-inp">
                           ...
                           <div class="form-group text-right">
                              <a class="e-com-1-link-f" href="#">Forgot Password ?</a>
                           </div>
                           <div class="form-group">
                              @if(!isset($temploginsetting))
                              
                                 <button type="button" id="login_button" class="e-com-1-right-button btn btn-dark" href="#">Log in</button>
                              @else
                              <button type="button" id="login_button" class="e-com-1-right-button btn btn-dark" href="#" style="background-color:{{$temploginsetting->login_btn_color}}; font-size:{{$temploginsetting->login_btn_font_size}}px;">Log in</button>
                              
                              @endif   
                           </div>
                           <p class="e-com-1-crate-acount-p">Create a new account?<a class="cor-1-crate-acount" href="#"> Sign up</a></p>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="row">
            ...
            <div class="col-md-4 own-4-col ">
               <div class="preview-box">
                  <h2 class="text-center preview-title "><img  class="" src="{{asset('asset/images/eyeimage.png')}}" alt="eyeimage">Preview</h2>
                  <div class="tutorial-video-box text-center">
                     <div class="app-preview e-com-1-app-preview e-com-1-group-container e-com-1-top-heade-nav e-com-1-sign-login">
                        ...
                        @endif
                           <div class="e-com-1-top-header-img">
                             ...
                             <div class="e-com-1-log-header-img">                                
                                 ...
                                 @if(!isset($tempsignupsetting))
                                 <img class="" id="signup_back" src="{{asset('images/econ-1-top-bg.png')}}" alt="">
                                 @elseif($tempsignupsetting->signup_bg_image == NULL)
                                 <img class="" id="signup_back" src="{{asset('images/econ-1-top-bg.png')}}" alt="">
                                 @else
                                 <img class="" id="signup_back" src="{{asset($tempsignupsetting->signup_bg_image)}}" alt="">
                                 @endif

                              @if(!isset($tempsignupsetting))   
                                 <div id ="signup_back1" class="e-com-1-shap"></div>
                                 <div id ="signup_back2" class="e-com-2-shap"></div>
                              @else
                                 <div id ="signup_back1" class="e-com-1-shap" style="background-color:{{$tempsignupsetting->signup_bg_color}};">
                                 </div>
                                 <div id ="signup_back2" class="e-com-2-shap" style="background-color:{{$tempsignupsetting->signup_bg_color}};">
                                 </div>
                              @endif

                              </div>
                           </div>
                           <div class="e-com-1-sign-grp-container">
                              <div class="form-group e-com-1-email-group m-b-5">
                                 <label class="e-com-1-gr-label">Full Name</label>
                                 <div class="e-com-1-group-icn-inp">
                                    <i class="fa fa-user" aria-hidden="true"></i>
                                    <input class="form-cantrol capitalize-input" type="text" placeholder="Enter Full Name" autocomplete="off">
                                 </div>
                              </div>
                              <div class="form-group e-com-1-email-group m-b-5">
                                 <label class="e-com-1-gr-label">Email</label>
                                 <div class="e-com-1-group-icn-inp">
                                    <i class="fa fa-envelope cor-1-envicon" aria-hidden="true"></i>
                                    <input class="form-cantrol" type="email" placeholder="Enter Your Email" autocomplete="off">
                                 </div>
                              </div>
                              <div class="form-group e-com-1-password-group m-b-5">
                                 <label class="e-com-1-gr-label">Password</label>
                                 <div class="e-com-1-group-icn-inp">
                                    <i class="fa fa-lock cor-1-lock" aria-hidden="true"></i>
                                    <input class="form-cantrol" type="Password" placeholder="Enter Your Password" autocomplete="off">
                                 </div>
                              </div>
                              <div class="form-group e-com-1-email-group">
                                 <label class="e-com-1-gr-label">Number</label>
                                 <div class="e-com-1-group-icn-inp">
                                    <i class="fa fa-phone" aria-hidden="true"></i>
                                    <input class="form-cantrol" type="Number" placeholder="Enter Your Number" autocomplete="off">
                                 </div>
                              </div>
                              <div class="form-group">
                              @if(!isset($tempsignupsetting))
                                 <button type="button" id="signup_button" class="e-com-1-right-button btn btn-dark" href="#">Sign Up </button>
                              @else
                                 <button type="button" id="signup_button" class="e-com-1-right-button btn btn-dark" href="#" style="background-color:{{$tempsignupsetting->signup_btn_color}}; font-size:{{$tempsignupsetting->signup_btn_font_size}}px;">Sign Up </button>
                              @endif
                              </div>
                              <p class="e-com-1-crate-acount-p">Have an account?<a class="e-com-1-crate-acount" href="#"> Log in</a></p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-8 own-8-col">
                  <div class="row card owncard addprdctrow">
                     ...
                     <h2 class="add_title mb-30">Add Collections <a class="tooltip-btn" data-tooltip="Here you can upload your categories" data-tooltip-location="right"> ?</a></h2>
                        <form class="p-10" method="POST" action="{{route('theme.meal_collections.store')}}" enctype="multipart/form-data" >
            ...
            <div class="preview-box">
               ...
               <div class="tutorial-video-box">
                  <div class="app-preview cor-1-app-preview cor-1-group-container appallscreenpreview">
                     ...
                     <img class="appfrm appscreenprewe " src="{{asset('template/images/ecom-1-myprofile.jpg')}}"alt="">
                     </div>
                     <div class="theme-slide-itm">
                     <img class="appfrm appscreenprewe " src="{{asset('template/images/ecom-1-wishlist.jpg')}}" alt="">
                     </div>
                     <div class="theme-slide-itm">
                     <img class="appfrm appscreenprewe" src="{{asset('template/images/ecom-1-checkout.jpg')}}" alt="">
                     </div>
                     <div class="theme-slide-itm">
                     <img class="appfrm appscreenprewe" src="{{asset('template/images/ecom-1-payment.jpg')}}" alt="">
                     </div>
                     </div>
