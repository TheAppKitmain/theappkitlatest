                        ...
                        <div class="row owncard addprdctrow mt-20 addprdctrowmaintabs">
                           <div class="col-md-12">
                              <div class="tab">
                                 ...
                                 <button id="login1" class="tablinks" onclick="openCity(event, 'login')">Login / Signup<span class="theme-tab-number-w">2</span></button>
                                 @else
                                 <button id="login1" class="tablinks" onclick="openCity(event, 'login')">Login / Signup<span class="theme-tab-number-green">2</span></button>
                                 @endif

                                 @if(count($collections) == 0)
                                 <button id="home1" class="tablinks" onclick="openCity(event, 'beauty_home')">Home<span class="theme-tab-number-w">3</span></button>
                                 @else
                                 <button id="home1" class="tablinks" onclick="openCity(event, 'beauty_home')">Home<span class="theme-tab-number-green">3</span></button>
                                 @endif

                                 @if(count($products) == 0)
                                 <button id="add_prodcut1" class="tablinks" onclick="openCity(event, 'add_prodcut')">Add Product <span class="theme-tab-number-w">4</span> </button>
                                 @else
                                 <button id="add_prodcut1" class="tablinks template-tab-color" onclick="openCity(event, 'add_prodcut')">Add Product <span class="theme-tab-number-green">4</span></button>
                                 @endif      
      ...
      <div class="main-container-inner">
         <div class="container-fluid">
            <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <textarea class="form-control" id="product_description" name="product_description" placeholder="Product Description" rows="6"></textarea>
                                       </div>
               ...
               <div class="col-md-4 own-4-col beauty-col-4product">
                        ...
                        <div class="tutorial-video-box-inner">
                           <div class="preview-right-main-wrapper">
                              ...
                              <div class="p-mobile-header">
                                 <img class="tglimg" src="{{asset('asset/images/preview/tglimg.png')}}" alt="toggle image">
                                    ...
                                    @if(!isset($splashscreen))
                                       <img class="logoprv preview" id="preview" src="{{asset('template/images/beauty_creams/makeup_black.png')}}" alt="logo"> 
                              ...
                              <div class="product-preview-container">
                                    ...
                                    <div class="carousel-inner">
                                       <div class="carousel-item active">
                                          <div class="product-image-box">
                                             ...
                                             <img class="productimgprv product_image_screen" src="{{asset('template/images/beauty_creams/productimg-w.png')}}" id="product_image_screen" alt="toggle image">
                                       ...
                                       <div class="carousel-item">
                                          <div class="product-image-box">
                                             ...
                                             <img class="productimgprv display_image_screen" src="{{asset('template/images/beauty_creams/productimg-w.png')}}" id="product_image_screen" alt="toggle image">
                                       ...
                                       <div class="carousel-item">
                                          <div class="product-image-box">
                                             ...
                                             <img class="productimgprv display_image_screen_2" src="{{asset('template/images/beauty_creams/productimg-w.png')}}" id="product_image_screen" alt="toggle image">
                                       ...
                                       <div class="carousel-item">
                                          <div class="product-image-box">
                                             ...
                                             <img class="productimgprv display_image_screen_3" src="{{asset('template/images/beauty_creams/productimg-w.png')}}" id="product_image_screen" alt="toggle image">
                                 ...
                                 <div class="beautyheartboxmain">
                                 <div class="beautyheartbox">
                                       <img class="beautyhrt" src="{{asset('template/images/beauty_creams/beauty-heart.png')}}" alt="toggle image">
                                       <i class="fa fa-heart" aria-hidden="true"></i>
                                       </div>
                                       </div>
                                 <div class="product-name-box">
                                    <h3 id="pro_name">Laura Mercier Oil Free</h3>
                                    <div class="p-price-box text-center">

                                       @if(Auth::user()->country == 'United Kingdom')
                                          <span class="p-old-price"><img  class="cur_pound_preview" src="{{asset('images/cur-2.png')}}" alt="right-mobile"><spam id="sale_price_preview">28.99 </spam></span>
                                          <span class="new-price"><img  class="cur_pound_preview_1" src="{{asset('images/cur-2.png')}}" alt="right-mobile"><spam id="pro_price">35.99 <spam></span>
                                       @else
                                          <span class="p-old-price">$<spam id="sale_price_preview">28.99 </spam></span>
                                          <span class="new-price">$<spam id="pro_price">35.99 <spam></span>
                                       @endif
                                 ...
                                 <div class="p-product-des-box">
                                    ...
                                    <div class="row no-gutters beautycolor-select">
                                       <div class="col-md-12">
                                       ...
                                       <div class="col-md-12">
                                          <ul class="p-size-ul list-inline beauty_template_size" id="ecomm_size_select">
                                             <li class="selected-licolor list-inline-item">100gm</li>
                                             <li class="list-inline-item">200gm</li>
                                             <li class="list-inline-item select-lisize">400gm</li>
                                             <li class="list-inline-item">600gm</li>
                                          </ul>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="bottom-fav-button d-flex text-center beautyfavbtn">
                                    <button type="submit" class="btn beautycreambutton">Add to Bag</button>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="card-body m-t-20">
               <form  method ="POST" action="{{route('theme.splashscreen')}}" enctype="multipart/form-data" name="splashscreen_form">
                  ...
                  <div class="d-flex form-group formgrouplabel">
                     ...
                     <div class="delete-box-cm" id="remove_logo_image" onClick="removebeautylogoimg()" style="display: none;"><i class="fa fa-trash-o delete-icon-cm" aria-hidden="true"></i> Remove logo image</div>
                  </div>
                  ...
                  <div class="d-flex form-group formgrouplabel">
                     ...
                     <div class="delete-box-cm" id="remove_splash_image" onClick="removebeautysplashimg()" style="display: none;"><i class="fa fa-trash-o delete-icon-cm" aria-hidden="true"></i> Remove splash image
                     </div>
                  </div>
            ...
            <div class="tutorial-video-box text-center">
                <div class="tutorial-video-box-inner">
                    ...
                    @if(!isset($splashscreen))
                        ...
                        <img class="splashbg" src="{{asset('template/images/beauty_creams/skin-splash-bg.png')}}" id="splash_bg" alt="">  
                        <img class="applogoimg preview" src="{{asset('template/images/beauty_creams/logo_skincare.png')}}" id="splash_logo" alt="">
                        </div>
                    @else
                        ...
                        @if($splashscreen->splash_background_color == "#ffffff" && !is_null($splashscreen->splash_background_image))
                           ...
                           @if($splashscreen->splash_logo == NULL)
                                 ...
                                 <img class="applogoimg preview" src="{{asset('template/images/beauty_creams/logo_skincare.png')}}" id="splash_logo" alt="eyeimage">   
                           @else
   ...
   <div class="tab-content-inner">
      <div class="row">
               ...
               <div class="card-body m-t-20">
                  <form  method ="POST" action="{{route('theme.loginscreen')}}" enctype="multipart/form-data" name="login_form">
                     ...
                     <div class="d-flex form-group formgrouplabel">
                        ...
                        <div class="delete-box-cm" id="remove_login_image" onClick="removebeautyloginimg()" style="display: none;"><i class="fa fa-trash-o delete-icon-cm" aria-hidden="true"></i> Remove image</div>
         ...
         <div class="preview-box">
                <h2 class="text-center preview-title "><img class="" src="{{asset('asset/images/eyeimage.png')}}" alt="eyeimage">Preview</h2>
                <div class="tutorial-video-box text-center">
                    <div class="tutorial-video-box-inner beauty_cream_tutorial">
                        <div class="preview-right-main-wrapper loginsign-ecom ecomm_beauty_login">

                        <div id="back_image" class="e-com-1-background-color-ver" ></div>                   
                        <div class="splash-bgimage">    

                            @if(!isset($temploginsetting))
                            <img class="loginsignbg" id="login_image" src="{{asset('template/images/beauty_creams/skin-loginbg.png')}}" alt="">
                            @elseif($temploginsetting->login_bg_image == NULL)
                            <img class="loginsignbg" id="login_image" src="{{asset('template/images/beauty_creams/skin-loginbg.png')}}" alt="">
                            @else
                            <img class="loginsignbg" id="login_image" src="{{asset($temploginsetting->login_bg_image)}}" alt="">
                            @endif   




                        <div class="ecom-5-beauty-sign">

                        <div class="ecom-5-beauty-sign-inner">
                            <i class="fa fa-arrow-left e-com-5-back-icon-sign" aria-hidden="true"></i>

                           @if(!isset($splashscreen))
                           <img class="sign-applogoimg preview" id="preview"  src="{{asset('template/images/beauty_creams/logo_skincare.png')}}" alt="logo">
                           @elseif ($splashscreen->splash_logo == NULL)
                           <img class="sign-applogoimg preview" id="preview"  src="{{asset('template/images/beauty_creams/logo_skincare.png')}}" alt="logo">
                           @else
                           <img class="sign-applogoimg preview" id="preview"  src="{{asset($splashscreen->splash_logo)}}" alt="logo"> 
                           @endif   


                        </div>
                        <ul class="nav nav-tabs ecom-5-sign-navtab" id="myTab" role="tablist">
                                <li class="nav-item">
                        ...
                        <div class="tab-content ecom-5-sign-tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="e-com-5-top-header-img">
                            <div class="e-com-5-log-header-img">
                                <img class="e-com-2log-img" src="images/red-logo.png" alt="">
                            </div>
                            </div>
                            <div class="e-com-5-form-grp-container e-com-5-form-mr">
                            <div class="form-group e-com-5-email-group">
                                <label class="e-com-5-gr-label">Email</label>
                                <div class="e-com-5-group-icn-inp">
                                    <input class="form-cantrol" type="email" placeholder="Enter Your Email">
                                </div>
                            </div>
                            <div class="form-group e-com-5-password-group ecomm-b-5">
                                <label class="e-com-5-gr-label">Password</label>
                                <div class="e-com-5-group-icn-inp">
                                    <input class="form-cantrol" type="Password" placeholder="Enter Your Password">
                                </div>
                            </div>
                            <div class="form-group text-right">
                                <a class="e-com-5-link-f" href="#">Forgot Password?</a>
                            </div>
                            <div class="form-group">

                              @if(!isset($temploginsetting))       
                              <button type="button" id="login_button" class="e-com-5-right-button ecom-5-logo-inbtn btn" href="#">Log in</button>
                              @else
                                 <button type="button" id="login_button" class="e-com-5-right-button ecom-5-logo-inbtn btn" href="#" style="background-color:{{$temploginsetting->login_btn_color}}; font-size:{{$temploginsetting->login_btn_font_size}}px;">Log in</button>                           
                              @endif   
                               
                            </div>
                            </div>
                            </div>
                            <div class="tab-pane fade ecom5-tab-signup" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="e-com-5-form-grp-container e-com-5-form-mr">
                            <div class="form-group e-com-5-email-group">
                                <label class="e-com-5-gr-label">Name</label>
                                <div class="e-com-5-group-icn-inp">
                                    <input class="form-cantrol" type="text" placeholder="Enter Your Name">
                                </div>
                            </div>
                            <div class="form-group e-com-5-email-group">
                                <label class="e-com-5-gr-label">Email</label>
                            ...
                            <div class="form-group e-com-5-password-group">
                                <label class="e-com-5-gr-label">Password</label>
                                <div class="e-com-5-group-icn-inp">
                                    <input class="form-cantrol" type="Password" placeholder="Enter Your Password">
                                </div>
                            ...
                            <div class="form-group e-com-5-email-group">
                                <label class="e-com-5-gr-label">Phone Number</label>
                                <div class="e-com-5-group-icn-inp">
                                    <input class="form-cantrol" type="email" placeholder="Enter Your Number">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <button type="button" id="login_button" class="e-com-5-right-button ecom-5-logo-inbtn ecom-mt-20 btn" href="#">Sign Up</button>

                              @else

                              <button type="button" id="login_button" class="e-com-5-right-button ecom-5-logo-inbtn ecom-mt-20 btn" href="#" style="background-color:{{$temploginsetting->login_btn_color}}; font-size:{{$temploginsetting->login_btn_font_size}}px;">Sign Up</button>
...
<!-------------------------------------============================  Home Screen ==========================----------------------------------------------->
      <div id="beauty_home" class="tabcontent">
         <div class="tab-content-inner">
            <div class="row">
            <!--====== Add Collection =====-->  
               <div class="col-md-8 own-8-col beauty_home-col-8">
                  <div class="row card owncard addprdctrow">
                     <div class="col-md-12">
                     <h2 class="add_title mb-30">Add Collections <a class="tooltip-btn" data-tooltip="Here you can upload your categories" data-tooltip-location="right"> ?</a></h2>
                        <form class="p-10" method="POST" action="{{route('theme.collections.store')}}" enctype="multipart/form-data" >
                           ...
                           <div class="form-group">
                              <label class="pr-label" for="exampleInputPassword1">Collection Image: <a class="tooltip-btn" data-tooltip="Upload image 1152 x 219 px" data-tooltip-location="right"> ?</a></label>
               ...
               <div class="preview-box">
                    ...
                    <div class="tutorial-video-box text-center">
                        <div class="tutorial-video-box-inner">
                            <div class="ecom-5home">
                            <div class="ecom-5home-top">
                                <i class="fa fa-bars e-com-5-tglimg" aria-hidden="true"></i>
                                
                                <i class="fa fa-search e-com-5-srchicn" aria-hidden="true"></i>
                            </div>

                            @if(!isset($splashscreen))
                           <img class="com-5-sign-applogoimg preview" id="preview"  src="{{asset('template/images/beauty_creams/makeup_black.png')}}" alt="logo">
                           @elseif ($splashscreen->splash_logo == NULL)
                           <img class="com-5-sign-applogoimg preview" id="preview"  src="{{asset('template/images/beauty_creams/makeup_black.png')}}" alt="logo">
                           @else
                           <img class="com-5-sign-applogoimg preview" id="preview"  src="{{asset($splashscreen->splash_logo)}}" alt="logo"> 
                           @endif   
                          
                            
                            </div>
                            @if(count($collections) == 0)
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-1.png')}}" alt="">
                            ...
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-2.png')}}" alt="">
                            <h4>Lip Care</h4>
                            </div>
                            </div>
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-3.png')}}" alt="">
                            <h4>Cleansing</h4>
                            </div>
                            </div>
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-4.png')}}" alt="">
                            <h4>Skin Brightening</h4>
                            </div>
                            </div>
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-5.png')}}" alt="">
                            <h4>Sun Protection</h4>
                            </div>
                            </div>
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-6.png')}}" alt="">
                            <h4>Hydration</h4>
                            </div>
                            </div>
                            <div class="ecom-5home-inner-catgory">
                            <div class="ecom-5home-inner-catgory-image">
                            <img class="com-5-catimages" src="{{asset('template/images/beauty_creams/beauty-cat-7.png')}}" alt="">
                            <h4>Anti-Ageing</h4>
                            </div>
                            </div>
                            ...
                            <img class="com-5-catimages" src="{{asset('template/images/dummy_product_2.png')}}" alt="">

                            <h4>{{$collection->collection_name}}</h4>

                            @else

                            <img class="com-5-catimages" src="{{config('services.base_url').$collection->collection_image}}" alt="">
                            <h4>{{$collection->collection_name}}</h4>
...
<div id="rest_screens" class="tabcontent">
               ...
               <div class="preview-box">
                  ...
                  <div class="tutorial-video-box">
                     <div class="app-preview cor-1-app-preview cor-1-group-container">                 
                        ...
                        <img class="appfrm appscreenprewe " src="{{asset('template/images/beauty_creams/17.png')}}" alt="">
                        </div>
                        <div class="theme-slide-itm">
                        <img class="appfrm appscreenprewe " src="{{asset('template/images/beauty_creams/20.png')}}" alt="">
                        </div>
                        <div class="theme-slide-itm">
                        <img class="appfrm appscreenprewe" src="{{asset('template/images/beauty_creams/12.png')}}"  alt="">
                        </div>
                        <div class="theme-slide-itm">
                        <img class="appfrm appscreenprewe"  src="{{asset('template/images/beauty_creams/14.png')}}" alt="">
                        </div>
                        </div>                    
                  </div>
               </div>
  ...
  <div class="modal fade popup-template-modal" id="account_screen" role="dialog">
      <div class="modal-dialog modal-dialog-centered">
         ...
         <div class="modal-body">
            <h1>The screen will show a user other sections</h1>
               <button class="btn-ok" data-dismiss="modal">Ok</button>
         </div>
         </div>
      </div>
...
function removebeautyloginimg() {
 
  document.getElementById("login_image").src = "{{asset('template/images/beauty_creams/skin-loginbg.png')}}";
}
...
else if(cityName == "beauty_home"){

   var screen4 =  $.cookie("beauty_home");

   if(screen4 == undefined)
   {

   $('body').find('#home_screen').modal('show');
   $.cookie("beauty_home", 1);
