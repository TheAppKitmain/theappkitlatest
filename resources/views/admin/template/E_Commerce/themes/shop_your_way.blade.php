                                    ...
                                    <div class="main-container-inner">
                                       <div class="container-fluid">
                                        ...
                                        @endif                                                                     </div>
                                             ...
                                             <!----====== Product Preview =====---->
                                             <div class="col-md-4 own-4-col ecom-3-prod">
                                                      ...
                                                      <div class="tutorial-video-box-inner">
                                                         <div class="preview-right-main-wrapper">
                                                            ...
                                                            <div class="e-com-3-bottom-fav-button d-flex">
                                                                  ...
                                                                  @else
                                                                  <span class="ecom-pricespan">Price: 
                                                                  <span class="p-old-price ecom-pricespan">$<spam class="e-com-3-p-old-price" id="sale_price_preview">90.00</spam></span>
                                                                  </span>
                                                                  <span class="new-price e-com-3-new-price">$<spam id="pro_price">80.00<spam></span>
                                                                  @endif
                                                                  </div>
                                                               </div>
                                                               ...
                                                               <!-- <div class="e-com-3-bottom-fav-button d-flex">
                                                               <h3 id="pro_name">COMFY CHAIR</h3>
                                                               <div class="e-com-3-p-price-box ">
                                                                  <span class="ecom-pricespan">Price:<span class="e-com-3-p-old-price "> $90.00</span></span>
                                                                  <span class="e-com-3-new-price">
                                                                  $80.00
                                                                  </span>
                                                               </div>
                                                            </div> -->
                              ...
                              <div class="row">
                                       ...
                                       <form  method ="POST" action="{{route('theme.splashscreen')}}" enctype="multipart/form-data" name="splashscreen_form">
                                        ...
                                        @endif                                          </div>
                                          ...
                                          <div class="d-flex form-group formgrouplabel">
                                             ...
                                             <div class="delete-box-cm" id="remove_logo_image" onClick="removefurniturelogoimg()" style="display: none;"><i class="fa fa-trash-o delete-icon-cm" aria-hidden="true"></i> Remove logo image</div>
                                          </div>
                                          <div class="d-flex form-group formgrouplabel">
                                             ...
                                             <input type="file" accept="image/*" id="inp2"  class="form-control splash_bg_image" name="splash_background_image" onchange="splshbgshopimgshow()">
                                          ...
                                          <div class="d-flex form-group">
                                             ...
                                             @if($splashscreen == NULL)
                                             <input type="color" id="splash_bg_color" name="splash_bg_color" onchange="splshbgshopwayshow()" value="#ffffff"> 
                                             @else
                                             @if($splashscreen->splash_background_color !== "#ffffff")
                                             <input type="color" id="splash_bg_color" name="splash_bg_color" onchange="splshbgshopwayshow()" value="{{$splashscreen->splash_background_color}}">
                                             @else
                                             <input type="color" id="splash_bg_color" name="splash_bg_color" onchange="splshbgshopwayshow()" value="{{$splashscreen->splash_background_color}}">
                                             @endif 
                                             @endif
                                 ...
                                 <div class="col-md-4 own-4-col">
                                    <div class="preview-box">
                                       ...
                                       <div class="tutorial-video-box-inner">
                                          <div class="">
                                             <div class="app-preview-inner e-com-3-app-preview e-com-3-group-container e-com-3-top-heade-nav e-com-3-sign-login">
                                                <div class="preview-right-main-wrapper">
                                                   @if(!isset($splashscreen))
                                                   <div class="e-com-3-splashbg splash-bgimage" id="splash_screen_bg">
                                                      <img class="splashbg" src="{{asset('asset/images/splash/spalshbg.png')}}" id="splash_bg" alt="eyeimage" >
                                                      <img class="e-com-3-applogoimg preview" src="{{asset('template/images/shop_your_way/shopyourway.png')}}" id="splash_logo" alt="eyeimage">
                                                   </div>
                                                   @else
                                                      @if($splashscreen->splash_background_color == "#ffffff" && !is_null($splashscreen->splash_background_image))
                                                         ...
                                                         <img class="e-com-3-applogoimg preview" src="{{asset('template/images/shop_your_way/shopyourway.png')}}" id="splash_logo" alt="eyeimage">  
                                                         @else
                                                         <img class="e-com-3-applogoimg preview" src="{{asset($splashscreen->splash_logo)}}" id="splash_logo" alt="eyeimage">
                                                         @endif
                                                         <div>
                                                         @elseif($splashscreen->splash_background_color == "#ffffff" && $splashscreen->splash_background_image == null)
                                                         <div class="e-com-3-splashbg splash-bgimage" id="splash_screen_bg">
                                                            <img class="splashbg" src="{{asset('asset/images/splash/spalshbg.png')}}" id="splash_bg">
                                                            @if($splashscreen->splash_logo == NULL) 
                                                            <img class="e-com-3-applogoimg preview" src="{{asset('template/images/shop_your_way/shopyourway.png')}}" id="splash_logo" alt="eyeimage">
                                                            @else 
                                                            <img class="e-com-3-applogoimg preview" src="{{asset($splashscreen->splash_logo)}}" id="splash_logo" alt="eyeimage">
                                                      ...
                                                      @else
                                                         <div class="e-com-3-splashbg splash-bgimage" id="splash_screen_bg" style="background-color:{{$splashscreen->splash_background_color}};">
                                       ...
                                       <div class="col-md-8 own-8-col">
                                        ...
                                        @endif                                                   </div>
                                                   ...
                                                   <div class="d-flex form-group">
                                                      ...
                                                      <input type="color" id="login_bg_color1" name="login_btn_color" onchange="loginbtnshow()" value="#F15A2A">                     
                                                   </div>
                                                   @else
                                                   <div class="d-flex form-group">
                                                      <label class="lbh">Login Background Color</label>
                                             ...
                                             <div class="tutorial-video-box text-center">
                                                <div class="app-preview cor-1-app-preview cor-1-group-container">
                                                   <div class="app-preview-inner e-com-3-app-preview e-com-3-group-container e-com-3-top-heade-nav e-com-3-sign-login">
                                                      ...
                                                      <div id="back_image" class="e-com-3-background-color-ver"></div>
                                                      @else
                                                      <div id="back_image" class="e-com-3-background-color-ver" style="background-color:{{$temploginsetting->login_bg_color}};"></div>
                                                      @endif
                                                      <div class="e-com-3-top-header-img">
                                                   
                                                         <div class="e-com-3-log-header-img">
                                                            @if(!isset($splashscreen))
                                                            <img class="e-com-2log-img preview" id="preview"  src="{{asset('template/images/shop_your_way/shopyourway.png')}}" alt="logo">
                                                      ...
                                                      <div class="e-com-3-form-grp-container e-com-3-form-mr">
                                                         <div class="form-group e-com-3-email-group">
                                                            <label class="e-com-3-gr-label">Email</label>
                                                            <div class="e-com-3-group-icn-inp">
                                                               <!-- <i class="fa fa-envelope cor-1-envicon" aria-hidden="true"></i> -->
                                                               <input class="form-cantrol" type="email" placeholder="Enter Your Email">
                                                            </div>
                                                         </div>
                                                         <div class="form-group e-com-3-password-group m-b-5">
                                                            <label class="e-com-3-gr-label">Password</label>
                                                            <div class="e-com-3-group-icn-inp">
                                                         ...
                                                         <div class="form-group text-right">
                                                            <a class="e-com-3-link-f" href="#">Forgot Password?</a>
                                                         </div>
                                                         <div class="form-group">
                                                            @if(!isset($temploginsetting))
                                                            <button type="button" id="login_button" class="e-com-3-right-button ecom-2-logo-inbtn btn btn-dark" href="#">Sign in</button>
                                                            @else
                                                            <button type="button" id="login_button" class="e-com-3-right-button ecom-2-logo-inbtn btn btn-dark" href="#" style="background-color:{{$temploginsetting->login_btn_color}}; font-size:{{$temploginsetting->login_btn_font_size}}px;">Sign in</button>
                                                            @endif  
                                                         </div>
                                                         <p class="e-com-3-crate-acount-p">Create a new account?<a class="cor-1-crate-acount" href="#"> Sign up</a></p>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-8 own-8-col">
                                        ...
                                        @endif                                                   </div>
                                                   ...
                                                   <div class="d-flex form-group">
                                                      ...
                                                      <input type="color" id="signup_bg_color1" name="signup_btn_color" onchange="signupbtnshow()" value="#F15A2A">                     
                                                   </div>
                                                   @else
                                                   <div class="d-flex form-group">
                                                      <label class="lbh">SignUp Background Color</label>
                                       ...
                                       <div class="col-md-4 own-4-col ">
                                          <div class="preview-box">
                                             <h2 class="text-center preview-title "><img class="" src="{{asset('asset/images/eyeimage.png')}}" alt="eyeimage">Preview</h2>
                                             <div class="tutorial-video-box text-center">
                                                <div class="app-preview e-com-3-app-preview e-com-3-group-container e-com-3-top-heade-nav e-com-3-sign-login">
                                                   <div class="app-preview-inner">
                                                      ...
                                                      <div class="e-com-3-sign-grp-container">
                                                         <div class="form-group e-com-3-email-group m-b-5">
                                                            <label class="e-com-3-gr-label">Full Name</label>
                                                            <div class="e-com-3-group-icn-inp">
                                                         ...
                                                         <div class="form-group e-com-3-email-group">
                                                            <label class="e-com-3-gr-label">Number</label>
                                                            <div class="e-com-3-group-icn-inp">
                                                         ...
                                                         <div class="fo rm-group">
                                                            @if(!isset($tempsignupsetting))
                                                            <button type="button" id="signup_button" class="e-com-3-right-button e-com-3-sign-upbtn btn btn-dark" href="#">Sign Up </button>
                                                            @else
                                                            <button type="button" id="signup_button" class="e-com-3-right-button e-com-3-sign-upbtn btn btn-dark" href="#" style="background-color:{{$tempsignupsetting->signup_btn_color}}; font-size:{{$tempsignupsetting->signup_btn_font_size}}px;">Sign Up </button>
                                                            @endif
                                                         </div>
                                                         <p class="e-com-3-crate-acount-p">Create a new account?<a class="e-com-3-crate-acount" href="#"> Sign in</a></p>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                          ...
                                          <div class="preview-box">
                                             ...
                                             <div class="tutorial-video-box text-center">
                                                <div class="app-preview cor-1-app-preview">
                                                   ...
                                                   <div class="e-com-3-top-home">
                                                      @if(count($collections) == 0)
                                                      <div class="row no-gutters">
                                                         <div class="col-md-12">
                                                            <img class="e-com-3-logohome" src="{{asset('template/images/shop_your_way/shopyourway.png')}}" alt="logo"> 
                                                         </div>
                                                         <div class="col-md-6">
                                                            <div class="e-com-3-cat-imgtext">
                                                               <div class="e-com-3-cat-imgtext-inner">														 
                                                                  <img class="e-com-3-pro-1" src="{{asset('template/images/shop_your_way/pro-1.png')}}" alt="">
                                                               </div>
                                                               <h3>Decorative</h3>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-6">
                                                            <div class="e-com-3-cat-imgtext">
                                                               <div class="e-com-3-cat-imgtext-inner">														 
                                                                  <img class="e-com-3-pro-1" src="{{asset('template/images/shop_your_way/pro-2.png')}}" alt="">
                                                               </div>
                                                               <h3>Design</h3>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-6">
                                                            <div class="e-com-3-cat-imgtext">
                                                               <div class="e-com-3-cat-imgtext-inner">														 
                                                                  <img class="e-com-3-pro-1" src="{{asset('template/images/shop_your_way/pro-3.png')}}" alt="">
                                                               </div>
                                                               <h3>Sideboard</h3>
                                                            </div>
                                                         </div>
                                                         <div class="col-md-6">
                                                            <div class="e-com-3-cat-imgtext">
                                                               <div class="e-com-3-cat-imgtext-inner">														 
                                                                  <img class="e-com-3-pro-1" src="{{asset('template/images/shop_your_way/pro-4.png')}}" alt="">
                                                               </div>
                                                               <h3>Seed Plant</h3>
                                                            </div>
                                                         </div>
                                                         ...
                                                         <div class="col-md-6">
                                                            <div class="e-com-2-cat-imgtext">
                                                               <div class="e-com-3-cat-imgtext-inner">	
                                                                  ...
                                                                  @else														 
                                                                  <img class="e-com-3-pro-1" src="{{config('services.base_url').$collection->collection_image}}" alt="">
                                                                  @endif
                                                               </div>
                                    ...
                                    <div class="preview-box">
                                       ...
                                       <div class="tutorial-video-box">
                                          <div class="app-preview cor-1-app-preview cor-1-group-container">
                                             ...
                                             <img class="appfrm appscreenprewe " src="{{asset('template/images/shop_your_way/14.png')}}" alt="">
                                             </div>
                                             <div class="theme-slide-itm">
                                             <img class="appfrm appscreenprewe " src="{{asset('template/images/shop_your_way/15.png')}}" alt="">
                                             </div>
                                             <div class="theme-slide-itm">
                                             <img class="appfrm appscreenprewe" src="{{asset('template/images/shop_your_way/10.png')}}"  alt="">
                                             </div>
                                             <div class="theme-slide-itm">
                                             <img class="appfrm appscreenprewe"  src="{{asset('template/images/shop_your_way/12.png')}}" alt="">
                                             </div>
                                             </div>
...
<script>
   ...
   function removefurniturelogoimg() {   
     document.getElementById("splash_logo").src = "{{asset('template/images/shop_your_way/shopyourway.png')}}";
