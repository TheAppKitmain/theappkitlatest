                  ...
                  <div class="row">
                     <div class="col-md-4 color-1-col">
                        ...
                        @foreach($data['new_orders']->slice(0,5) as $order)
                              <a href="{{route('theme.myorders.show',$order->id)}}">
                        ...
                        @if(count($data['new_orders'])>5)
                           <button onclick="window.location.href='{{route('theme.new_orders')}}';" class="btn-seemore">See More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                        @endif 
                        @endif                               
                        </div>                       
                     </div>                   
                     ...
                     <div class="col-md-4 color-2-col p-l-0">
                        ...
                        @if(count($data['confirmed_orders']))
                          ...
                          @if(count($data['confirmed_orders'])>5)
                           <button onclick="window.location.href='{{route('theme.confirmed_orders')}}';" class="btn-seemore">See More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                        @endif
                          @endif    
                        </div>
                     </div>
                     ...
                     <div class="col-md-4 color-3-col p-l-0">
                        ...
                        @if(count($data['shipped_orders'])>5)
                           <button onclick="window.location.href='{{route('theme.shipped_orders')}}';" class="btn-seemore">See More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                        @endif
                        @endif                             
                        </div>
                     </div>
