         ...
         <div class="row clearfix text-left">
            <div class="col-md-12">
               <div class="row card owncard">
                  <div class="col-md-12">
                    <h2 class="add_title">Add Coupon</h2>

                        <form method ="POST" action="{{route('theme.storecoupon')}}" enctype="multipart/form-data" id="coupon_validation">
                           @csrf
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="coupon_code" class="form-control inputtemp" required>
                           </div>

                           <div class="form-group">
                              <label class="pr-label">Description</label>
                              <input type="text" name="description" class="form-control inputtemp" required>
                           </div>

                           <div class="form-group">
                              <label class="pr-label">Cart Amount</label>
                              <input type="text" name="cart_amount" class="form-control inputtemp" required>
                           </div>

                           <div class="form-group">
                              <label class="pr-label">Discount type</label>
                              <select name="discount_type" class="form-control inputtemp" required>
                           ...
                           <div class="form-group">
                              ...
                              <input type="number" name="discount" class="form-control inputtemp" required>
                           </div>

                           <div class="form-group">
                              <label class="pr-label">Limit</label>
                              <input type="number" name="limit" class="form-control inputtemp" required>
                           </div>

                           <div class="form-group">
                              <label class="pr-label">From</label>
                              <input type="text" id="datepicker" name="from_date" placeholder="yy-mm-dd" class="form-control inputtemp" required>
                           </div>

                           <div class="form-group">
                              <label class="pr-label">To</label>
                              <input type="text" id="datepicke" name="to_date" placeholder="yy-mm-dd" class="form-control inputtemp" required>
                           </div>
