          ...
          <div class="col-md-4">
            <div class="mt-20">
              <div class="">
                ...
                <div class="card-body"> 
                  <form method="POST" action="{{route('temp_update_customer_user',[$project_manager->id])}}" enctype="multipart/form-data" name="registration">
                  @csrf
                  {{ method_field('PUT') }}
                  ...
                  <table class="table">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{$user->number}}</td>
                              <td>
                              <a class="btn btn-info" href="{{route('temp_edit_customer_user',[$user->id])}}">Edit</a>
                                <a class="btn btn-danger" onclick="delete_pm('{{route('temp_delete_user',[$user->id])}}')">Delete</a>
                              </td>
                          </tr>    
                          @endforeach
                      </tbody>
