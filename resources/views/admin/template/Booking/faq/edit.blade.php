...
<div class="main-home">
      ...
      <div class="card-main card">
            	...
            	<div class="container-fluid">
               		<div class="container-fluid">
               			<form action="{{ route ('theme.booking_faqs.update', $faq->id) }}" method="post" enctype="multipart/form-data">
               			@csrf
               			{{ method_field('PUT') }}
			   			<div class="row">
						   <div class="form-group">
                                ...
                                <div class="form-group">
                        		<input type="hidden" class="inputtemp form-control" name="template_id" value="{{$faq->template_id}}">
                        	</div>
			   				<div class="col-lg-12">
								<div class="form-group f-g-o">
						  			<label for="usr">Question</label>
						  			<textarea class="form-control" placeholder="Add Question" name="question" required="required">{{ old('question',$faq->question ?? '') }}</textarea>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group f-g-o">
						  			<label for="usr">Answer</label>
						  			<textarea class="form-control" placeholder="Add Answer" name="answer" required="required">{{ old('answer',$faq->answer ?? '') }}</textarea>
								</div>
							</div>
