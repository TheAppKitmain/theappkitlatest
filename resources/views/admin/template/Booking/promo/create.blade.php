...
<div class="main-home">
      ...
      <div class="card-main card">
        	...
        	<div class="container-fluid">
           		<div class="container-fluid">
           			<form role="form" data-toggle="validator" action="{{route('theme.booking_promo.store')}}" method="post" enctype="multipart/form-data">@csrf
		   			<div class="row">
					   <div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group f-g-o">
					  			...
					  			<input type="text" class="form-control{{ $errors->has('promo_code') ? ' is-invalid' : '' }}" placeholder="Enter Promo Code" name="promo_code" required data-error="This field is required." value="{{ old('promo_code') }}">
						...
						<div class="col-lg-12">
							<div class="form-group f-g-o">
					  			...
					  			<input type="number" class="form-control{{ $errors->has('discount') ? ' is-invalid' : '' }}" placeholder="Enter Discount" data-error="This field is required." name="discount" value="{{ old('discount') }}">
						...
						<div class="col-lg-12">
							<div class="form-group f-g-o">
					  			...
					  			<textarea class="form-control" placeholder="Add Description" required data-error="This field is required." name="description">{{ old('description') }}</textarea>
					  			<div class="help-block with-errors"></div>
							</div>
						</div>
