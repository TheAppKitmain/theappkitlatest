          ...
          <div class="col-md-4">
            <div class="mt-20">
              <div class="">
                ...
                <div class="card-body"> 
                  <form method="POST" action="{{route('update_project_manager',[$project_manager->id,'PM'])}}" enctype="multipart/form-data" name="registration">
                  @csrf
                  {{ method_field('PUT') }}
                  <div class="form-group project-man-form">
                    <label for="Name">Name*</label>
                    <input type="text" name="manager_name" class="form-control" placeholder="Enter Name" value="{{ old('manager_name',$project_manager->first_name) }}" required> 
                    ...
                    <input type="text" class="form-control" value="Project Manager" readonly>
              ...
              <div class="mt-20">
                ...
                <div class="table-height-container">
                  <table class="table">
                      ...
                      <tbody>
                          @foreach ($all_project_manages  as $key => $user)
                          <tr>
                              <td scope="row">{{++$key}}</td>
                              ...
                              <td>{{$user->number}}</td>
                              <td>
                               <a class="viewbtn" href="{{route('edit_project_manager',[$user->id,'PM'])}}">Edit</a>
                                <a class="viewbtn" onclick="delete_pm('{{route('delete_project_manager',[$user->id,'PM'])}}')">Delete</a>
                              </td>
                          </tr>    
                          @endforeach
                      </tbody>
