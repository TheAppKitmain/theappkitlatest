...
<div class="row clearfix">
    ...
    <div class="mt-20 addteame-main">
        ...
        <div class="card-body">    
        	<form role="form" data-toggle="validator" action="{{route('our_work.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-6 col-xl-6 col-md-12">
                    <div class="form-group f-g-o">
                        <label for="usr">App name</label>
                        <input type="text" class="form-control{{ $errors->has('app_name') ? ' is-invalid' : '' }}" placeholder="Add title" name="app_name" required value="{{ old('app_name') }}" data-error="This field is required.">
                ...
                <div class="col-lg-6 col-xl-6 col-md-12" id="post_thumnail">
                    <div class="form-group f-g-o">
                        ...
                        <input type="file" name="app_logo" id="imgInp file-7" class="inputfile inputfile-6 form-control{{ $errors->has('app_logo') ? ' is-invalid' : '' }}" accept="image/*">
                ...
                <div class="col-lg-6 col-xl-6 col-md-12">
                    <div class="form-group f-g-o">
                        ...
                        <input type="text" name="client_name" id="imgInp file-7" class="inputfile inputfile-6 form-control{{ $errors->has('client_name') ? ' is-invalid' : '' }}" accept="image/*">
                ...
                <div class="col-lg-6 col-xl-6 col-md-12">
                    <div class="form-group f-g-o">
                        ...
                        <input type="text" name="client_designation" id="imgInp file-7" class="inputfile inputfile-6 form-control{{ $errors->has('client_designation') ? ' is-invalid' : '' }}" accept="image/*">
                ...
                <div class="col-lg-6 col-xl-6 col-md-12">
                    <div class="form-group f-g-o">
                        ...
                        <input type="link" name="app_links" id="imgInp file-7" class="inputfile inputfile-6 form-control{{ $errors->has('app_links') ? ' is-invalid' : '' }}" accept="image/*">
                ...
                <div class="col-lg-6 col-xl-6 col-md-12">
                    <div class="form-group f-g-o">
                        ...
                        <input type="link" name="app_android_link" id="imgInp file-7" class="inputfile inputfile-6 form-control{{ $errors->has('app_android_link') ? ' is-invalid' : '' }}" accept="image/*">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="app_reviews" id="app_reviews" rows="8" cols="50" class="form-control  @error('app_reviews') is-invalid @enderror" required></textarea>
                    @error('app_reviews')
                            <span class="invalid-feedback" role="alert">
