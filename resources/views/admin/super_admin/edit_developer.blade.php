          ...
          <div class="col-md-4">
            <div class="mt-20">
              <div class="">
                ...
                <div class="card-body"> 
                  <form method="POST" action="{{route('update_project_manager',[$project_manager->id,'DV'])}}" enctype="multipart/form-data" name="registration">
                  @csrf
                  {{ method_field('PUT') }}
                  ...
                  <table class="table">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{$user->number}}</td>
                              <td>
                               <a class="viewbtn" href="{{route('edit_project_manager',[$user->id,'DV'])}}">Edit</a>
                                <a class="viewbtn" onclick="delete_pm('{{route('delete_project_manager',[$user->id,'DV'])}}')">Delete</a>
                              </td>
                          </tr>    
                          @endforeach
                      </tbody>
